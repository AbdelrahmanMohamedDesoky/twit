...
Twitter.prototype.put = function (path, params, callback) {
  return this.request('PUT', path, params, callback)
}

Twitter.prototype.update = function (path, params, callback) {
  return this.request('UPDATE', path, params, callback)
}

Twitter.prototype.request = function (method, path, params, callback) {
  var self = this;
  assert(method == 'GET' || method == 'POST' || method == 'DELETE' || method == 'UPDATE' || method == 'PUT');
